  ...
  data() {
    return {
      subjects: [
        ...
        { id: 'd_math', name: 'Дискретная математика', emoji: '⊂' },
        ...
        { id: 'rus_lang', name: 'Русский язык', emoji: '🇷🇺' },
        { id: 'rus_lit', name: 'Литература', emoji: '📚' },
        { id: 'eng_lang', name: 'Английский язык', emoji: '🇬🇧' },
        { id: 'g_lang', name: 'Немецкий язык', emoji: '🇩🇪' },
        { id: 'fr_lang', name: 'Французский язык', emoji: '🇫🇷' },
        { id: 'ch_lang', name: 'Китайский язык', emoji: '🇨🇳' },
        { id: 'sp_lang', name: 'Испанский язык', emoji: '🇪🇸' },
        { id: 'lat_lang', name: 'Латинский язык', emoji: '🏛' },
        { id: 'hist', name: 'История', emoji: '📜' },
        { id: 's_st', name: 'Обществознание', emoji: '👥' },
        { id: 'law', name: 'Право', emoji: '⚖' },
        { id: 'econ', name: 'Экономика', emoji: '📈' },
        { id: 'fin_lit', name: 'Финансовая грамотность', emoji: '💰' },
        { id: 'arts', name: 'Искусство (МХК)', emoji: '🎨' },
        { id: 'tech', name: 'Технология', emoji: '🔧' },
        { id: 'pc_sci', name: 'Информатика', emoji: '💻' },
  ...
  methods: {
    ...
    async startTraining() {
      ...
      try {
        ...
        console.log(this.selectedSubject, this.taskQuantity);
