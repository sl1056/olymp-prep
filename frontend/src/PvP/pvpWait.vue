    ...
    <div class="page-content">
      <div class="match-card">
        ...
        <div class="match-properties">
          ...
          <div class="property-row">
            <span class="property-label">Вопросов:</span>
            <span class="property-value">{{ currentMatch.questionsCount }}</span>
          </div>
        </div>
...
export default {
  ...
  setup() {
    ...
    const currentMatch = ref({
      ...
      questionsCount: Number(localStorage.getItem('currentMatchQuestionsCount') || 1)
    })
    ...
    const handleWebSocketMessage = (data) => {
      ...
      switch(data.type) {
        case 'player_joined':
          ...
          if (userData.value && data.user_id !== userData.value.id) {
            stopStatusChecking();
            router.push('/PvP/Answer');
          }
          break;
