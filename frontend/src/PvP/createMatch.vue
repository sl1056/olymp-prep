...
const subjectsData = [
  ...
  { id: 'geom', name: 'Геометрия', icon: '△' },
  { id: 'd math', name: 'Дискретная математика', icon: '⊂' },
  ...
  { id: 'astro', name: 'Астрономия', icon: '🌌' },
  { id: 'rus lang', name: 'Русский язык', icon: '🇷🇺' },
  { id: 'rus lit', name: 'Литература', icon: '📚' },
  { id: 'eng lang', name: 'Английский язык', icon: '🇬🇧' },
  { id: 'g lang', name: 'Немецкий язык', icon: '🇩🇪' },
  { id: 'fr lang', name: 'Французский язык', icon: '🇫🇷' },
  { id: 'ch lang', name: 'Китайский язык', icon: '🇨🇳' },
  { id: 'sp lang', name: 'Испанский язык', icon: '🇪🇸' },
  { id: 'lat lang', name: 'Латинский язык', icon: '🏛' },
  { id: 'hist', name: 'История', icon: '📜' },
  { id: 's st', name: 'Обществознание', icon: '👥' },
  { id: 'law', name: 'Право', icon: '⚖' },
  { id: 'econ', name: 'Экономика', icon: '📈' },
  { id: 'fin', name: 'Финансовая грамотность', icon: '💰' },
  { id: 'art', name: 'Искусство (МХК)', icon: '🎨' },
  { id: 'tech', name: 'Технология', icon: '🔧' },
  { id: 'pc sci', name: 'Информатика', icon: '💻' },
  { id: 'robot', name: 'Робототехника', icon: '🤖' },
  { id: 'ai sci', name: 'Искусственный интеллект', icon: '🧠' },
  { id: 'pe', name: 'Физкультура', icon: '⚽' },
  { id: 'obzr', name: 'ОБЖ', icon: '🛡' },
